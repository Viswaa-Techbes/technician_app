            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionLabel(context, "Preferences & Configuration"),
                  const SizedBox(height: 16),
                  _buildMenuAction(
                    Icons.account_circle_outlined,
                    "Admin Details",
                    "Manage manager profile and roles",
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const AccountDetailsScreen()),
                    ),
                  ),
                  _buildMenuAction(Icons.lock_outline_rounded, "Privacy & Security", "Password and 2FA settings"),
                  _buildMenuAction(Icons.notifications_active_outlined, "Notification Settings", "Configure alert preferences"),
                  _buildMenuAction(Icons.admin_panel_settings_outlined, "System Settings", "Configure global app variables"),
                  ...
                  const Center(
                    child: Text(
                      "App Version v2.4.0 (Manager Portal)",
